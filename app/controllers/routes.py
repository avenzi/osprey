...
def downloadBoilerplate():
    # fileToDownload = request.form['fileToDownload'] + ".py"
    # return send_file(app.config['DOWNLOADS_FOLDER']/fileToDownload, as_attachment=True, mimetype="text/x-script.python")
