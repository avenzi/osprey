...
def create_layout(info):
    ...
    #fig.line(x='time', y='data', color='blue', source=transform_source)
    plot_sliding_js(fig, source)  # incoming data smoothing
    #plot_priority_js(fig, back_source=source, front_source=transform_source)  # give transformed data priority
